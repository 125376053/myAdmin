<template>
    <div class="orderDetails-wrapper">
        <!-- <div class="title"> -->
          ...
          <!-- <div class="divButton">
            <el-button type="primary" @click="downLoadCert(orderID)" v-show="ruleForm.orderInfo.statusDesc === '已签发' || ruleForm.orderInfo.statusDesc === '替换中' || ruleForm.orderInfo.statusDesc === '已替换' || ruleForm.orderInfo.statusDesc === '更新中' || ruleForm.orderInfo.statusDesc === '已更新'">下载证书</el-button> -->
            <!-- <el-button type="primary">更新</el-button>
            <el-button type="primary">替换</el-button> -->
            <!-- <el-button type="primary" @click="cancelOrder(orderID)" v-show="ruleForm.orderInfo.statusDesc === '待审核' || ruleForm.orderInfo.statusDesc === '待审批' || ruleForm.orderInfo.statusDesc === '待签发' || ruleForm.orderInfo.cancelPermission">取消订单</el-button>
          </div>
        </div> -->
                    ...
                    <el-col :span="8">
                      <el-popover
                        ...
                        <div style="text-align: right; margin-top: 20px;">
                          ...
                          <!-- <el-button type="primary" size="mini" @click="csrPop = false">关闭</el-button> -->
                        </div>
                        <el-button style="padding:0;" type="text" slot="reference">查看订单CSR</el-button>
                      </el-popover>
                        <!-- <el-button type="text">查看订单CSR</el-button> -->
                    </el-col>
                </el-row>
            </el-form-item>
            <el-form-item>
            ...
            <!-- <el-form-item class="authInput" v-show="ruleForm.orderInfo.productType !== 'DV'">
              <el-row :gutter="20">
                    <el-col :span="8">
                        ...
                        <el-form-item v-for="item in ruleForm.attachmentInfo" :label="item.attachmentName+':'" :key="item.index"  label-width="100px">
                            <el-button @click="downloadPerssion(orderID,item.attachmentID)" type="text">{{item.attachmentID}}.{{item.attachmentType}}</el-button>
                        </el-form-item>
                    </el-col>
                </el-row>
            </el-form-item> -->
...
export default {
  ...
  computed: {
    ...
    notBefore(){
       if (this.ruleForm.certInfo.notBefore !== "") {
        return this.ruleForm.certInfo.notBefore.slice(0,10)
       }else{
         return ""
       }
    },
    notAfter(){
       if (this.ruleForm.certInfo.notAfter !== "") {
        return this.ruleForm.certInfo.notAfter.slice(0,10)
       }else{
         return ""
       }
    }
  ...
  methods: {
    _getDetails(){
      this.$axios
      .post("/api/rapidOrder/detail", { orderID: this.orderID })
      .then(res => {
        let data = res.data;
        if (data.code === 0) {
          console.log(data);
    ...
    copyCSR(){
     ...
     back() {
      this.$router.push({ name: "serverOrderList" });
    }
  }
};
</script>
