<template>
    <div class="personalCenter-wrapper">
      ...
      <el-tabs v-model="activeName" class="personal-container"  @tab-click="tabPage">
        <el-tab-pane label="个人信息" name="first">
          <!-- <el-button type="primary" style="font-size:12px;" @click="handleClick(userType)">修改个人信息</el-button> -->
        ...
        <el-tab-pane label="常用组织信息" name="second">
        ...
        <el-tab-pane label="常用联系人信息" name="third">
          <el-card class="contacts-info box-card" style="margin-top:25px;">
            <div slot="header" class="clearfix">
                <span>常用联系人信息</span>
        ...
        <div class="editDialog">
            <el-dialog title="编辑个人信息" width="870px" :visible.sync="editPersonalInfoPri" >
                <div class="tips">
               ...
               <el-form ref="form" :model="form" :rules="!form.isRequstOrgUser?rules:rulesChangeOrg" label-width="80px">
                    ...
                    <el-form-item>
                        <el-row :gutter="10">
                          <el-col :span="7">
                                <div class="el-input-tit" style="width:84px;display:inline-block">国家</div>
                                <el-form-item prop="country" style="display:inline-block;margin-left:-4px;width:151px;" >
                  ...
                  <el-row>
                      <el-col :span="10">
                          <el-form-item label="部门" prop="favoriteContactDepartment">
                            <el-input size="samll" v-model="addContactForm.favoriteContactDepartment" placeholder="请输入部门名称" ></el-input>
                          </el-form-item>
                      </el-col>
                      <el-col :span="10">
...
export default {
  ...
  mounted() {
    ...
    // alert(this.$store.state.other.isClient)
  ...
  methods: {
    ...
    bindPhone(phone) {
      ...
      this.$router.push({ name: "clientRegister3", params: { phone: phone } });
    },
    changBindPhone(phone){
      // this.$router.push({name:"changeBindPhone",params:{phone:phone}})
      this.$router.push({name:"clientChangeBindPhone",params:{phone:phone}})
    },
          ...
          this.$axios
            ...
            .then(res => {
              ...
              if (data.code === 0) {
                ...
                let temp =(this.form.userLastName+this.form.userFirstName);
                // parent.changeName(temp);
...
.personalCenter-wrapper .contactOrgDialog .el-dialog__body{
  padding: 10px 20px;
}
.personalCenter-wrapper
  .editDialog
...
.personalCenter-wrapper th{
  font-weight: normal;
}
.personalCenter-wrapper .el-dialog__footer{
 padding: 0 20px 10px;
}
.el-form-item{
  margin-bottom:16px;
