                ...
                <el-tab-pane label="验证码登录" name="second">
                    ...
                    <el-form :model="loginFormValid" status-icon :rules="rules" ref="loginFormValid" label-width="100px" class="rule-form">
                        <el-form-item prop="verifyCode">
                            ...
                            <el-button style="width:80px;padding:0;height:32px;line-height:32px;margin-left:8px;border:none;" type="primary" disabled v-show="isCountDowm"><span >{{countTime}}s后发送</span></el-button>
                            <el-button style="width:80px;padding:0;height:32px;line-height:32px;margin-left:8px;border:none;" type="primary" v-show="!isCountDowm" @click="getVerifycode"><span >点击获取</span></el-button>
                        </el-form-item>
                        <el-form-item>
...
export default {
  ...
  methods: {
    toRegister() {
      this.$router.push({ name: "register",params:{isClient:true} });
    },
    toForgetPass() {
      this.$router.push({ name: "forgetPass",params:{isClient:true} });
    },
    pwdLogin(formName) {
