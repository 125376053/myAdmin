      ...
      <div class="forget-form-wrapper" v-show="show">
        ...
        <el-form :model="condition" :rules="rules" ref="ruleForm" label-width="92px">
          <el-form-item prop="verifyCode" >
            ...
            <el-button type="primary" style="width:96px;font-size:12px;padding:0;text-align:center;height:32px;line-height:32px;boder:none;" disabled v-show="isCountDowm">{{countTime}}s后发送</el-button>
            <el-button type="primary" style="width:96px;font-size:12px;padding:0;text-align:center;height:32px;line-height:32px;boder:none;" v-show="!isCountDowm" @click="getVerifycode(accountForm.userAccno)">点击获取</el-button>
          </el-form-item>
          <el-form-item prop="newPassword" class="password-input">
            ...
            <div style="margin-top:10px;color:#999;font-size:12px;line-height:14px;margin-top:6px;">
              <span style="display:inline-block;margin-right:8px;margin-top:8px;">安全密码强度</span>
        ...
        <div style="text-align:center">
          <el-button type="primary" style="text-align:center;margin-top:10px;" @click="resetPassword">重置密码</el-button>
        </div>
        <div class="oprate-btn">
          <el-button type="text" style="font-size:12px;" @click="toLogin">返回登录</el-button>
          <el-button type="text" style="font-size:12px;" @click="toRegister">立即注册</el-button>
        </div>
      </div>
    </transition>
  </div>
...
.forget-form-wrapper .el-form-item {
  margin-bottom: 18px;
}
